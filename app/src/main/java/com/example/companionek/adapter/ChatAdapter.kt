...
// Update the constructor to accept an onClick listener
class ChatAdapter(
    private val chatList: ArrayList<ChatItems>,
    private val onItemClick: (String) -> Unit // Add this parameter for the click listener
) : RecyclerView.Adapter<ChatAdapter.ChatViewHolder>() {
